...
<section class="social-media">
    <div class="container social-content">
        ...
        <a href="#" class="social-media-links"><ion-icon name="logo-youtube" class="icon-social"></ion-icon></a>
    </div>
</section>
<header class="header">
    <a href="#">
    ...
    <nav class="main-nav">
        <ul class="main-nav-list">
            ...
            <li><a href="#" class="nav-links">Entertainment</a></li>
            <li><a href="#" class="nav-links">Tell me Paster</a></li>
            <li><a href="#" class="nav-links">Vidoes</a></li>
            <li><a href="#" class="nav-links">Photos</a></li>
            <li><a href="#" class="nav-links">More</a> </li>
...
<section class="section-hero">
    <div class="container grid g-3-col mb-1">
        <div class="main-news">
